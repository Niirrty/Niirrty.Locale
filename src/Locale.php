 ...
 * </code>
 *
 * but {@see \Niirrty\Translation\Locale::Create()} does finally the same.
 *
 * @since  v0.1.0
 */
final class Locale
{
         ...
         ( false !== ( $lcStr = LocaleHelper::ConvertLCIDToWin( (string) $this ) ) ) )
      {
         ...
         if ( ! empty( $cid ) )
         {
            ...
            if ( 2 === \count( $tmp ) )
            {
               ...
               $this->_locales[] = $lid . '_' . $cid . '.' . $cset;
               $this->_locales[] = $lid . '-' . $cid . '.' . $cset;
               $this->_locales[] = $language . '_' . $country . '.' . $charset;
               $this->_locales[] = $language . '-' . $country . '.' . $charset;
               $this->_locales[] = $lid . '_' . $cid;
               $this->_locales[] = $lid . '-' . $cid;
   ...
   /**
    * This is a alias of {@see \Niirrty\Translation\Locale::getLID()}.
    *
    * @return string
    */
   ...
   /**
    * This is a alias of {@see \Niirrty\Translation\Locale::getCID()}.
    *
    * @return string
    */
    ...
    *
    * @param \Niirrty\Locale\Locale $refLocale Returns the Locale instance if the method return TRUE.
    ...
    *
    * @return \Niirrty\Locale\Locale|null
    */
